...
En tant que projet *open source*, Logos n'est pas seulement un ensemble de contributeurs individuels — c'est un corps civique. Nous nous organisons volontairement pour résoudre des problèmes, faire respecter des valeurs et bâtir des institutions qui servent le bien commun : la liberté individuelle et la prospérité collective. Notre culture repose sur la méritocratie, la propriété partagée, la responsabilité commune et la gouvernance transparente. Les contributions à la communauté — code, contenu, idées — sont reconnues et récompensées par des rôles permettant une participation plus active au réseau.
...
3. **Trouver les Premiers Enjeux** : Cherchez les enjeux étiquetés « good first issue » ou « help wanted »
...
* Soumettre une requête de tirage (*pull request*) avec une description claire des changements
